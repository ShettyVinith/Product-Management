...
<%
    ...
    if (reportType == null) {
        ...
        if (typeParam != null) {
            response.sendRedirect("reportCriteria?type=" + typeParam);
            return;
        }
    }
%>
...
<div class="container">
    ...
    <div class="main-content">
        <div class="header">
            <h1>Generate Report - <%= reportType != null ? reportType.toUpperCase() : "" %></h1>
        </div>

        <div class="content">

            <a href="reports.jsp" class="btn btn-secondary back-btn">
                <i class="fas fa-arrow-left"></i> Back to Reports
            </a>

            <div class="form-container animate-slide-up">
                <form action="ReportServlet" method="post">
                    <input type="hidden" name="action" value="<%= reportType %>"/>

                    <% if ("price".equals(reportType)) { %>
                        <div class="form-group">
                            <label class="form-label">Enter Minimum Price</label>
                            <input type="number" name="minPrice" step="0.01" class="form-control" required />
                        </div>
                    ...
                    <% } else if ("top".equals(reportType)) { %>
                        <div class="form-group">
                            <label class="form-label">Enter Top N</label>
                            <input type="number" name="topN" class="form-control" required />
                        </div>
    ...
    <select name="sortBy" class="form-control">
        ...
        <option value="quantity">Price</option>
        <option value="sales">Quantity</option>
    </select>
</div>
