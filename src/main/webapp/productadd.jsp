...
<head>
    ...
    <link rel="stylesheet" href="style.css"> <!-- If your CSS is external -->
         <style>
        :root {
            --primary: #673ab7;
            --primary-dark: #522e93;
...
<div class="container">
    ...
    <nav class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item"><a href="productadd.jsp" class="nav-link active"><i class="fas fa-plus-circle"></i> Add Product</a></li>
    ...
    <div class="main-content">
        ...
        <div class="content">
            ...
            <div class="form-container animate-slide-up">
                <h2 style="margin-bottom: 20px; color: var(--primary);">Add New Product</h2>
                <form action="addProduct" method="post">
                    ...
                    <div class="form-group">
        				...
        				<input type="number" name="sales" class="form-control" placeholder="Enter sales of items">
    				</div>
